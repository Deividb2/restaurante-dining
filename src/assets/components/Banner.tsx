...
export default function Banner() {
    return (
        <>
            <section className="flex flex-col md:flex-row md:justify-between lg:pr-36">
                <div className="flex flex-col gap-8 pl-6 pr-4 py-5 md:pl-12 lg:pl-20 xl:gap-10">
                    ...
                    <p className="max-w-[30rem] xl:text-xl">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam sint, explicabo optio ullam pariatur quam dicta fuga voluptate mollitia tenetur deserunt atque dolore cumque itaque nihil molestiae maiores quos perspiciatis.
                    </p>
                ...
                <div className="rounded-full bg-no-repeat bg-cover self-center w-[18rem] h-[18rem] md:w-[25rem] md:h-[20rem]
                lg:w-[30rem] lg:h-[25rem] xl:w-[31rem] xl:h-[30rem]"
                style={{backgroundImage: `url(${ChefeBanner})`}}></div>
            </section>

            <section className="hidden md:flex justify-center gap-3 flex-wrap mt-10 lg:mt-[100px] lg:mb-20">
...
const Imgs = (props:Images) => {
    return (
        <div className="w-[15rem] h-[14rem] bg-no-repeat bg-cover bg-center hover:scale-105 hover:object-cover" 
